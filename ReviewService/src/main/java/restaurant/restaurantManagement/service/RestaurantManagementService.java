...
public interface RestaurantManagementService {
	...
	void UpdateRestaurantImage(RestaurantVO vo) throws Exception;
	void DeleteRestaurant(RestaurantVO vo) throws Exception;
	RestaurantVO SelectRestaurant(RestaurantVO vo) throws Exception;
	List<?> SelectAllRestaurant() throws Exception;
	List<?> SelectCategoryRestaurant(RestaurantVO vo) throws Exception;
}
