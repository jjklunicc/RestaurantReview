...
public class EgovUserServiceImpl extends EgovAbstractServiceImpl implements EgovUserService {
	...
	public UserVO selectSample(UserVO vo) throws Exception {
		UserVO resultVO = UserDAO.selectSample(vo);
		if (resultVO == null)
	...
	public List<?> selectSampleList(UserDefaultVO searchVO) throws Exception {
		return UserDAO.selectSampleList(searchVO);
	}
	...
	public int selectSampleListTotCnt(UserDefaultVO searchVO) {
		return UserDAO.selectSampleListTotCnt(searchVO);
	}
